    ...
    <div>
      ...
      <div className="content max-w-4xl mx-auto h-full px-4">
        ...
        <div className="actions w-full rounded-lg my-4 flex gap-2">
          <button className="hover:bg-neutral-100 hover:shadow-sm border-accent-blue border-2 p-3 rounded-lg text-accent-blue">
            <svg
          ...
          <button className="hover:bg-neutral-100 hover:shadow-sm border-pink-400 border-2 p-3 rounded-lg text-pink-400">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              viewBox="0 0 640 512"
