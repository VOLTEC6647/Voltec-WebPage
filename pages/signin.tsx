    ...
    <div className="h-screen w-screen bg-background-blue">
      ...
      <div className="bg-background-blue pb-10 p-4">
        <div className="max-w-6xl mx-auto bg-background-blue">
          ...
          <div className="bg-background-blue form w-full border-2 topography rounded-xl border-white z-10 p-6 text-white flex flex-col justify-center items-start gap-5 mb-12">
