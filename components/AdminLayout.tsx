  ...
  return (
    <div className="h-screen flex flex-col md:flex-row w-full bg-neutral-900">
      ...
      <div className="content bg-dark text-black ml-80 w-full">
        <div className="top-bar flex justify-between items-center p-5 bg-neutral-800 text-white">
            ...
            {url.map((i, index, arr) => {
              ...
              return (
                <>
                  ...
                  {index == arr.length ? null : <span className="px-2">/</span>}
                </>
              );
            })}
          </div>
        ...
        <motion.div className="w-full p-5 text-white">{children}</motion.div>
      </div>
    </div>
  );
};
