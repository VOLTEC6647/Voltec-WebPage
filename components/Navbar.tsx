      ...
      <AnimatePresence>
        {showing ? (
          <motion.div
            ...
            className={`fixed top-0 z-10 bg-background-blue navbar-menu h-screen w-screen p-4 md:py-6 md:px-8`}
          >
            <div
              onClick={toggleNav}
              className="hover:text-accent-blue transition-all duration-100 hover:rounded-full hamburger-icon text-white justify-start items-center gap-6 font-space-grotesk font-bold"
            ...
            <div className="content grid grid-cols-1 md:grid-cols-3 md:h-full gap-4">
              <div className="links flex col-span-1 md:col-span-2 flex-col justify-start md:justify-center pt-4 md:pt-0 items-start font-space-grotesk md:h-full">
                <Link href="/">
              ...
              <div className="image py-0 md:py-20 h-56 md:h-auto">
